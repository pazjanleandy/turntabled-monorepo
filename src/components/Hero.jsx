    ...
    <>
      <header className={`relative ${className}`}>
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-64 bg-gradient-to-b from-transparent to-[var(--bg)] md:h-72" />
        </div>

        <div className="hero-dissolve pointer-events-none absolute inset-x-0 -bottom-[4.5rem] h-[8.5rem] md:-bottom-[5.5rem] md:h-[11rem]" />

        <div className="relative z-10 flex h-full flex-col items-center justify-end px-6 pb-12 text-center text-white md:pb-20">
          <div className={`w-full ${contentClassName}`}>
            ...
            <p className="mx-auto mb-5 max-w-2xl text-sm text-white/80 md:text-base">
              Keep a personal record of every album you spin, surface favorites, and follow what
        ...
        >
          ...
          >
            ...
            <div className="mt-4">
              ...
              />
              <p className="mt-2 text-xs text-muted">Mini search placeholder. Results will show here.</p>
            </div>
          </div>
        </div>
      ) : null}
