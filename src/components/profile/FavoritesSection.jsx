            ...
            {isLoadingFavorites
              ? Array.from({ length: 5 }).map((_, index) => (
                  <article key={`favorite-skeleton-${index}`} className="snap-start">
                    <div className="aspect-square animate-pulse rounded-xl border border-black/10 bg-black/10" />
              ...
              : favorites.length === 0
                ? (
                  <p className="mb-0 text-sm text-slate-600">
                    No favorite albums yet. Add some from Manage.
                  </p>
                )
                    ...
                    return (
                      <article key={key} className="snap-start">
                        ...
                        <div className="mt-2">
                          ...
                          <StarRating
                            value={favoriteRatings[key] ?? album.rating ?? 0}
